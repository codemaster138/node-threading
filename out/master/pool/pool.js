...
var log = require('debug')('subservient:pool');
var WorkerPool = /** @class */ (function () {
    ...
    WorkerPool.prototype.awaitFreeWorker = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.awaitFreeWorker()];
                    case 1:
                        worker = _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, worker];
                }
            });
        });
    };
    ...
    WorkerPool.prototype.endAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, w;
    ...
    WorkerPool.prototype.end = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
